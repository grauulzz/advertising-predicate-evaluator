...
public class GenerateAdActivityDagger implements RequestHandler<GenerateAdvertisementRequest,
                                                                       GenerateAdvertisementResponse> {
    private static final LambdaComponent dagger = DaggerLambdaComponent.create();

    @Override
    public GenerateAdvertisementResponse handleRequest(GenerateAdvertisementRequest generateAdvertisementRequest,
                                                       Context context) {
