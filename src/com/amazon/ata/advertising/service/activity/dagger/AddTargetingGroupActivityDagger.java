...
public class AddTargetingGroupActivityDagger implements
        RequestHandler<AddTargetingGroupRequest, AddTargetingGroupResponse> {
    private static final LambdaComponent dagger = DaggerLambdaComponent.create();

    @Override
    public AddTargetingGroupResponse handleRequest(AddTargetingGroupRequest addTargetingGroupRequest,
                                                   Context context) {
