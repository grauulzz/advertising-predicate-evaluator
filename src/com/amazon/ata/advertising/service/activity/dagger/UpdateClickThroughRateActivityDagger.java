...
public class UpdateClickThroughRateActivityDagger implements RequestHandler<UpdateClickThroughRateRequest,
                                                                                   UpdateClickThroughRateResponse> {
    private static final LambdaComponent dagger = DaggerLambdaComponent.create();

    @Override
    public UpdateClickThroughRateResponse handleRequest(UpdateClickThroughRateRequest updateClickThroughRateRequest,
                                                        Context context) {
